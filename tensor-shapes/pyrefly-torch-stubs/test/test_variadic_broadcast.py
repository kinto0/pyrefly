...
def add_different_variadics[As: SymIntTuple, Bs: SymIntTuple, C: SymVar](
...
def add_same_variadic[Bs: SymIntTuple, C: SymVar](
...
def mul_different_variadics[As: SymIntTuple, Bs: SymIntTuple, C: SymVar](
    a: Tensor[[*Elements[As], C]], b: Tensor[[*Elements[Bs], C]]
) -> Tensor:
