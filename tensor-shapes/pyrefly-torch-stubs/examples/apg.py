...
class HyperNet[IN: SymIntVar, OUT: SymIntVar](nn.Module):
...
class APGMLP[InDim: SymIntVar, OutDim: SymIntVar](nn.Module):
...
class APGBackbone[F: SymIntVar, D: SymIntVar, OutD: SymIntVar](nn.Module):
