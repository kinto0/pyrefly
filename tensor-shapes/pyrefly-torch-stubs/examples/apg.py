...
class HyperNet[IN: SymVar, OUT: SymVar](nn.Module):
...
class APGLinear[IN: SymVar, OUT: SymVar, CD: SymVar, RK: SymVar, OP: SymVar](nn.Module):
...
class APGMLP[InDim: SymVar, OutDim: SymVar](nn.Module):
...
class APGBackbone[F: SymVar, D: SymVar, OutD: SymVar](nn.Module):
