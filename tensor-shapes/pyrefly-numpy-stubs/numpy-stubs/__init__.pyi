...
@overload
def zeros[N: IntVar, ScalarT: generic](
    shape: tuple[Int[N]], dtype: type[ScalarT], order: str = ...
) -> ndarray[[N], dtype[ScalarT]]: ...
@overload
def zeros[N: IntVar, M: IntVar, ScalarT: generic](
    shape: tuple[Int[N], Int[M]], dtype: type[ScalarT], order: str = ...
...
@overload
def zeros[N: IntVar, ScalarT: generic](
    shape: tuple[Int[N]], dtype: dtype[ScalarT], order: str = ...
) -> ndarray[[N], dtype[ScalarT]]: ...
@overload
def zeros[N: IntVar, M: IntVar, ScalarT: generic](
    shape: tuple[Int[N], Int[M]], dtype: dtype[ScalarT], order: str = ...
) -> ndarray[[N, M], dtype[ScalarT]]: ...
@overload
def zeros[N: IntVar](
...
@overload
def zeros[N: IntVar](
    shape: tuple[Int[N]], dtype: None = ..., order: str = ...
) -> ndarray[[N], dtype[float64]]: ...
@overload
def zeros[N: IntVar, M: IntVar](
    shape: tuple[Int[N], Int[M]], dtype: None = ..., order: str = ...
) -> ndarray[[N, M], dtype[float64]]: ...
@overload
def zeros[N: IntVar](shape: Int[N], dtype: Any, order: str = ...) -> ndarray[[N]]: ...
@overload
def zeros[N: IntVar](
    shape: tuple[Int[N]], dtype: Any, order: str = ...
) -> ndarray[[N]]: ...
@overload
def zeros[N: IntVar, M: IntVar](
    shape: tuple[Int[N], Int[M]], dtype: Any, order: str = ...
) -> ndarray[[N, M]]: ...
@overload
...
@overload
def full[N: IntVar](
    shape: tuple[Int[N]], fill_value: Any, dtype: Any = ..., order: str = ...
) -> ndarray[[N]]: ...
@overload
