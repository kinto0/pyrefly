...
see [Getting Started](./tensor-shapes-setup.mdx#option-2-shape_extensionssymvar-runtime-compatible)
for the `shape_extensions.SymVar` import style, which requires old-style
generics.
:::
